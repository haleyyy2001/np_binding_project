...
param0 = [  0.3694  ,  8.3323  ,  0.2962   ,57.1731 ,  14.2418];

%param0 = [19, 0.5, 9.9, 0.18, 4.7, 1]; % (kd, pt, mu, alpha, C, KD) where KD is CA passage ratio.
% : 1.5307891e-01   8.2404843e+00   5.7240507e-02   6.6634050e-02   2.7217036e+02
%dtcr=3;; 0.1444   19.9378    0.0078    3.1323   90.2258

% dtcr=5;;0.3644    8.3401    0.2982   57.3019   14.3576
% 0.3694    8.3323    0.2962   57.1731   14.2418
% Computation of initial variance
ss0 = louis_errorEngage(param0,data);
