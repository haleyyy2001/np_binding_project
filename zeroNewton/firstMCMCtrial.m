...
ss0 = errorFunctionParFitting(param0,data);
...
f1 = figure(101);
mcmcplot(chain,[],result.names,'denspanel');
...
f3 = figure(103);
mcmcplot(chain,[],result.names,'hist');
% saveas(f3,['hist',num2str(r),'_',num2str(nsim)],'jpg')

minind = 1501; % startpoint of convergence
