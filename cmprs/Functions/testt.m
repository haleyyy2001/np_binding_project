...
random_numbers = rand(10, 1);
random_numsmall = rand(5, 1);
...
% Add scale on the line and draw horizontal grid lines
scale_values = -1:0.25:2; % Scale from 10 to 80 with a gap of 10
...
for i = 1:length(scale_values)
    % Add text labels
    text(koff_position + 0.03, normalized_scale_values(i), num2str(10^scale_values(i)), 'HorizontalAlignment', 'left');
