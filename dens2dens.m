...
dens_tcr(i)=tcr_per_cluster./ (pi * cluster_radius^2);0
dens_cluster(i)=num_clusters./ (pi * rSurf^2);
...
plot3(dens_tcr,dens_cluster,prob)
hold on
end

xlabel('dens of tcr');ylabel('dens of cluster');
grid on
